...
class Text2MotionDatasetV2LoRA(data.Dataset):
    def __init__(self, opt, mean, std, split_file, w_vectorizer):
        self.opt = opt
        self.w_vectorizer = w_vectorizer
        self.max_length = 20
...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='./dataset/humanml_opt.txt', split="train", **kwargs):
        ...
        elif mode in ['train', 'eval', 'text_only', 'lora']:
            # used by our models
        ...
        if mode == 'text_only':
            ...
            self.t2m_dataset = Text2MotionDatasetV2LoRA(self.opt, self.mean, self.std, self.split_file, self.w_vectorizer)
