...
from data_loaders.tensors import t2m_collate, lora_collate
...
def get_dataset_class(name):
    if name == "amass":
        ...
        from data_loaders.humanml.data.dataset import BabelLoRa
        return BabelLoRa
    else:
...
def get_dataset(name, num_frames, split='train', hml_mode='train'):
    ...
    if name in ["humanml", "kit"]:
        ...
        dataset = DATA(split=split, num_frames=num_frames, mode="lora")
    else:
